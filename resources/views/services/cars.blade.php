...
<div class="car-section" data-car="kia-section">
    ...
    <div class="d-flex align-items-start">
        <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            <a href="{{route('car', 1)}}" class="nav-link active w-100 mb-2" id="v-pills-cerato-tab" data-bs-toggle="pill"
            ...
            <a href="{{route('car',2)}}" class="nav-link w-100 mb-2" id="v-pills-profile-tab" data-bs-toggle="pill"
